...
$email = $_SESSION['email'];
			...
			$qry = mysqli_query($con,"SELECT l_name, d_id FROM doctor WHERE email = '$email'");
			$row = mysqli_fetch_array($qry);
			
			$l_name = $row['l_name'];
            $d_id = $row['d_id'];

$query = "select * from appointment where d_id = '$d_id'";
...
<body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br><br>
        <div class="w3-container w3-row">
            ...
            <div class="w3-col s8 w3-bar">
                <span>Welcome Doctor <strong><?php echo $row['l_name']; ?></strong></span><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="d_logout.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-sign-out"></i>  Logout</a>
            <br><br>
        </div>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
        ...
        <div class="w3-container">
            <h2 style="color: darkgreen;font-weight: bold;">Appointments</h2>
            ...
            <div class="w3-row">
                <table id="customers">
                    ...
                    <tr>
                        ...
                        <td ><a href="approve.php?a_id=<?php echo $rows['a_id'];?>"
                        <button class="w3-button w3-large w3-teal" style="font-size: 10px;"><strong>Approve</a>
                        </button></td>

                        <td ><a href="reject.php?a_id=<?php echo $rows['a_id'];?>"
                        <button class="w3-button w3-large w3-teal" style="font-size: 10px;"><strong>Reject</a>
                        </button></td>
