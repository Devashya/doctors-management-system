...

{
    ...
    $z_code =$_POST["z_code"];
                    ...
                    include './connection.php';
                    $sql =  "UPDATE doctor set f_name='$f_name', l_name='$l_name', email='$email', city='$city', gender='$gender', major='$major', z_code='$z_code' where d_id = $d_id ";
...
<body class="w3-light-grey">
    ...
    <div class="w3-bar w3-top w3-black w3-large" style="z-index:4">
        ...
        <span class="w3-bar-item w3-right"></i></span>
    </div>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      <div class="w3-container">
        ...
        <table style="text-align:center;width:700px" border="0">
          ...
          <tr>
            <td>Email:</td>
            <td><textarea name="email"> <?php echo "$email" ?> </textarea required></td>
          </tr>
          <tr>
            <td>City:</td>
          ...
          <tr>
            <td>Zip Code:</td>
            <td><input type="text" name="z_code" value="<?php echo "$z_code" ?>" required></td>
          </tr>
          <tr>
